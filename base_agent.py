...
The core autonomy lives in _reason(): it calls Claude with the full
negotiation context + available tools, then executes whatever tools Claude
decides to call.  No conditional logic dictates the outcome — the LLM
decides everything.
"""
import os
import json
